...
<head>
    ...
    <meta itemprop="name" content="Empresa Traveller - Faça seu login ou cadastre-se! ">
    <meta itemprop="description" content="">
    <meta itemprop="image" content="">
    <!-- Tags meta Open Graph Facebook -->
    <meta property="og:title" content="Empresa Traveller - Faça seu login ou cadastre-se! ">
    <meta property="og:description" content="">
    <meta property="og:site_name" content="SOS Terra">
    <meta property="og:type" content="website">
    <meta property="og:image" content="">
    <!-- Tags meta Twitter -->
    <meta name="twitter:title" content="Empresa Traveller - Faça seu login ou cadastre-se!">
        ...
        <div class="overlay-container">
            <div class="overlay">
                <div class="overlay-panel overlay-left">
                    ...
                    <p>Escolha uma das opções para entrar em sua conta</p>
                    <button class="ghost" id="signIn">Entrar</button>
                </div>
                <div class="overlay-panel overlay-right">
                    <h1>Novo aqui ?</h1>
                    <p>Crie sua conta e desfrute de tudo que podemos oferecer</p>
